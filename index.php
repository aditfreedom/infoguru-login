...
<link rel="icon" href="ssb.png" type="image/png">
 <!-- Required meta tags -->
    ...
    <title>Info Guru SSB <?= $LOKASI ?></title>
...
<nav class="navbar navbar-expand-lg navbar-light bg-transparent  " id="nav">
        <div class="container">
        <a class="navbar-brand font-weight-bold text-info" href="#"> <img src="logo.png" width="50px" height="50px"> SISTEM INFORMASI SEKOLAH TERPADU ONLINE</img></a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item active">
              <a class="nav-link" href="http://www.sukmabangsabireuen.sch.id/">WEBSITE<span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="https://www.facebook.com/profile.php?id=100013199972355">FACEBOOK</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://www.instagram.com/sukmabangsabrn/">INSTAGRAM</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://www.youtube.com/channel/UC2J9QWDMC4AYMVdrGOcPK4g">YOUTUBE</a>
              </li>
          </ul>
        </div>
    </div>
...
<tr>
    ...
    <h1 class="display-4 text-dark  animate__animated animate__backInLeft">INFOGURU<br><span class="font-weight-bold">SEKOLAH SUKMA BANGSA<BR>BIREUEN</span> </h1>
...
<div class="d-flex p-2 justify-content-center bg-info text-white"><b>Copyright &copy; 2006 SISTO Sekolah Sukma Bangsa | version <?= $G_VERSION ?> build date <?= $G_BUILDDATE ?></div>
